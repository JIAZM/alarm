...
void OUTPUT_Init(void)
{
 ...
 GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_3|GPIO_Pin_4;	 //IO-->PF1、PF2、PF3、PF4 端口配置
 GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		                     //推挽输出
 GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;		                     //IO口速度为50MHz
 GPIO_Init(GPIOF, &GPIO_InitStructure);					                     //根据设定参数初始化PF1、PF2、PF3、PF4
 GPIO_SetBits(GPIOF,GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_3|GPIO_Pin_4);			 //PF1、PF2、PF3、PF4 输出高
